...
#define SCALAR_MIN (-1e9)
#define SCALAR_MAX (1e9)
#define SCALAR_EPSILON (1/SCALAR_MAX)
#define SCALAR_PI (3.14159265358979323846264338327950288419716939937510582)
#define SCALAR_TODEGREE (180.0/SCALAR_PI)
#define SCALAR_TORADIAN (SCALAR_PI/180.0)
